            ...
            <div class="w-100 mb-6">
                <div class="card bg-white border-2 border-gray-300 rounded-none shadow-none">
                    <div class="card-head px-8 border-b border-gray-300 flex justify-between items-center">
                        ...
                        <button class="bg-sky-400 text-white py-2 px-4 fs-5 flex items-center space-x-2"
                            @click="openAddCard">
                            <Icon name="heroicons:plus" class="me-2" size="18" /> <span>Add Card</span>
                        </button>
                    </div>
                    ...
                    <div class="card-body px-8 py-5">
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                            ...
                            <div class="col-span-8 space-y-6 py-5" v-if="cardlist">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-12 gap-8 mt-4">
                                        <div class="col-span-7">
                                            ...
                                            <Swiper :modules="[SwiperAutoplay, SwiperEffectCreative]"
                                                :slides-per-view="1" :loop="true" :effect="'creative'" @slideChange="onSlideChange">
                                                <SwiperSlide v-for="(activeCard) in creditCardList" :key="activeCard">
                                                    <div class="text-white p-6 rounded-md"
                                                        ...
                                                        <div class="">
                                                            <div class="flex  justify-between items-center mb-4">
                                                                <ul class="flex">
                                                                    ...
                                                                    <li v-if="activeCard.isArchived" class="archive">
                                                                        <Icon name="heroicons:credit-card" class="me-1" size="18" />
                                                                    </li>
                                                            ...
                                                            <div class>
                                                                <h4 class="text-xl font-semibold mb-2">{{ activeCard.name }}
                                                                </h4>
                                                                <div class="text-xl">
                                                                    <span v-if="activeCard.showNumber">{{ activeCard.cardNumber }}</span>
                                                                    <span v-else>• • • • &nbsp; • • • • &nbsp; • • • •
                                                                        &nbsp;
                                ...
                                <div class=""  v-if="debitCardList">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-12 gap-8 mt-4">
                                        <div class="col-span-7">
                                            ...
                                            <Swiper :modules="[SwiperAutoplay, SwiperEffectCreative]"
                                                :slides-per-view="1" :loop="true" :effect="'creative'" @slideChange="onSlideChangeDebit">
                                                <SwiperSlide v-for="(debactiveCard) in debitCardList" :key="debactiveCard">
                                                    <div class="text-white p-6 rounded-md"
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <div class>
                                                                <h4 class="text-xl font-semibold mb-2">{{ debactiveCard.name }}
                                                                </h4>
                                                                <div class="text-xl">
                                                                    <span v-if="debactiveCard.showNumber">{{ debactiveCard.cardNumber }}</span>
                                                                    <span v-else>• • • • &nbsp; • • • • &nbsp; • • • •
                                                                        &nbsp;
                                ...
                                <!-- <div class="">
                                    <div class="flex justify-between items-center">
                                        <h3 class="text-xl font-semibold text-sky-400">Debit Cards</h3>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-12 gap-8 mt-4">
                                        <div class="col-span-7">
                                            ...
                                            <div class="bg-indigo-900 text-white p-6 rounded-md">
                                                <div class="">
                                                    <div class="flex  justify-between items-center mb-4">
                                                        <ul class="flex">
                                                            <li v-if="lock" class="lock">
                                                                <Icon name="heroicons:lock-closed" class="me-1"
                                                                    size="18" />
                                                            </li>
                                                            <li class="archive">
                                                            ...
                                                            <li class="default">
                                                                <Icon name="heroicons:check" class="me-1" size="18" />
                                                            </li>
                                                            <li v-if="gpay" class="gpay"><img src="/assets/g-pay.png" alt=""> </li>
                                                        </ul>
                                                        <img src="/assets/hdfc.png" alt="Bank logo">
                                                    </div>
                                                    <div class>
                                                        <h4 class="text-xl font-semibold mb-2">John Watson</h4>
                                                        <div class="text-xl">
                                                            <span v-if="showNumber">9456 9456 9456 9340</span>
                                                            <span v-else>• • • • &nbsp; • • • • &nbsp; • • • • &nbsp;
                                                                9340</span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="mt-4 flex justify-between items-center">
                                                    <div class="text-sm"><strong>Valid Till : </strong> 12/24</div>
                                                    <div class="text-sm"><strong>CVV : </strong> • • •</div>
                                                    <div class="mb-4"><img src="/assets/mastercard.png" alt=""></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div class="flex flex-wrap justify-center items-center bg-gray-100 p-6 rounded-lg gap-y-8 gap-x-6 ">
                                                <button class="text-cyan-700 text-sm  xt-center flex flex-col items-center justify-center flex-auto"
                                                    @click="lock = !lock">
                                                    <div class="w-[40px] h-[40px] text-white mt-1 me-3 bg-sky-400 flex justify-center p-1 items-center rounded-full">
                                                        <Icon name="heroicons:lock-closed" class="" size="18" />
                                                    </div>
                                                    Lock Card
                                                </button>
                                                <button class="text-cyan-700 text-sm text-center flex flex-col items-center justify-center flex-auto"
                                                ...
                                                <button class="text-cyan-700 text-sm text-center flex flex-col items-center justify-center flex-auto"
                                                    @click="gpay = !gpay">
                                                    <div class="w-[40px] h-[40px] text-white mt-1 me-3  flex justify-center p-1 items-center rounded-full">
                                                       <img src="/assets/main-gpay.png" alt="gpay">
                                                    </div>
                                                    Add to GPay
                                                </button>
